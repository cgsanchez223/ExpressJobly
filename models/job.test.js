...
describe("findAll", function() {
    ...
    test("works: by min salary & equity", async function() {
        let jobs = await Job.findAll({ minSalary: 159, hasEquity: true });
        expect(jobs).toEqual([
            {
                id: testJobIds[1],
                title: "Job2",
...
// Test for getting examples - bringing up data
