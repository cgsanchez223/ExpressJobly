...
// added testJobIds, u2Token, and adminToken
const {
  commonBeforeAll,
  commonBeforeEach,
  commonAfterEach,
...
describe("GET /users", function () {
  ...
  // added unauth for non-admin users
...
/************************************** GET /users/:username */
// added admin tests and testJobIds
...
describe("GET /users/:username", function() {
  ...
  test("not found if user not found", async function () {
    const resp = await request(app)
        .get(`/users/nope`)
        .set("authorization", `Bearer ${adminTokenToken}`);
...
describe("PATCH /users/:username", () => {
  ...
  test("unauth is not same user", async function() {
    const resp = await request(app)
        .patch(`/users/u1`)
        .send({
          firstName: "New",
